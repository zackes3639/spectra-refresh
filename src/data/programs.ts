...
export const programs: Program[] = [
	{
		...
		who: [
			...
			"Patients seeking a thoughtful plan that connects biomarkers, symptoms, lifestyle, and goals.",
		],
		focus: [
			"Metabolic, inflammatory, hormonal, and recovery patterns.",
			"Advanced diagnostics interpreted through a whole-person clinical lens.",
			"Personalized protocols that can be refined as needs and markers change.",
		],
		included: [
		...
		journey: [
			{ title: "Map", copy: "Gather the clinical story, goals, labs, and lifestyle context." },
	...
	},
	{
		...
		who: [
			...
			"Patients interested in understanding the physiology behind stress, sleep, and fatigue.",
		...
		focus: [
			...
			"Daily practices and clinical recommendations that support recovery capacity.",
		],
		included: [
			"Recovery-oriented diagnostics",
			"Care planning for stress and sleep patterns",
		...
		outcome:
			"The goal is to help create more clinical clarity around recovery needs and support steadier capacity over time, without promising a specific outcome.",
	},
	{
		...
		who: [
			...
			"Patients who want hormonal and metabolic patterns considered together.",
		...
		included: [
			...
			"Personalized metabolic and hormonal care planning",
			"Lifestyle recommendations and patient education",
		...
		journey: [
			...
			{ title: "Reassess", copy: "Track what changes and adjust with care." },
		],
		outcome:
			"The intended experience is more context, steadier decision-making, and a care plan designed around the whole physiological picture, not a guaranteed clinical result.",
	},
	{
		title: "Precision Preventive Care",
		...
		who: [
			...
			"Patients with family history or risk patterns who want more personalized context.",
